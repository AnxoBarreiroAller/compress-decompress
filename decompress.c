...
void cda_processDecompress(char *input, char *output)
{
    ...
    {
    case ONE_BIT:
        cda_bitDecompression(compressedDataSize,g_alphabetTable,alphabetTableSize,data,output,1U);
        break;
    case TWO_BIT:
        cda_bitDecompression(compressedDataSize,g_alphabetTable,alphabetTableSize,data,output,2U);
        break;
    case THREE_BIT:
        cda_bitDecompression(compressedDataSize,g_alphabetTable,alphabetTableSize,data,output,3U);
        break;
    case FOUR_BIT:
        cda_bitDecompression(compressedDataSize,g_alphabetTable,alphabetTableSize,data,output,4U);
        break;
